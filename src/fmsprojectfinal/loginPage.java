...
{
	private JLabel lTitle;  /**< this is used to display text on gui window */
	private JLabel lLogin;/**< this is used to display text on gui window */
	private JLabel lPassword;/**< this is used to display text on gui window */
	
	private JTextField login;/**< this is used to input text on gui window */
	private JPasswordField pass;/**< this is used to input password on gui window */
	private JButton Ok;/**< this is used to display buns on gui window */
	private JButton Cancel;/**< this is used to display buns on gui window */
	...
	/* @brief actionlistener for the events */
