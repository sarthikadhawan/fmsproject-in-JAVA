...
/** @brief it will provide the layout of the staff page*/
public class staffPage extends JFrame
{
	JButton b;
	private JScrollPane scroll; /**< notification bar */
	private JTabbedPane myTab; /**< all tabs are added here */
	private JPanel homeP;   /**< panel for the home page */
	private JPanel task;   /**< panel for the task page*/
   private JPanel sendLeave;  /**< panel for the send leave */
	private JPanel sendLogstaff; /**< panel for the sendLogstaff */
	private int num = 0;        /**< get the no of items */
...
//		setLayout(null);
	...
	/** @brief this will be the action listener of the events */
...
/** @brief it will check the task of the staff */
