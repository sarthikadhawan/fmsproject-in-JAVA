...
/**@brief delete the newuser */
  ...
  {		
  	private String name=null;private String username=null; private String password=null;
  	 private int userid=0; private String DOB=null; private String address=null;
  	 task t[]=new task[1000];	 public int nooflogreq=0;
  	 private String status="Available";  	 private String statusoftask="Not started";
  	 filesupervisor f1;  	 gminventory g[]=new gminventory[1000];
    ...
    public int not=0,nog=0;
  	/**
  	 ...
  	 public void Setstatusoftask(String statusoftask){this.statusoftask=statusoftask;}
  		 public void Setnot(int not){this.not=not;}
  	 ...
  	 public void Setaddress(String address){this.address=address;}
  	  	 public String Getpassword(){return this.password;}
  	   	 ...
  	   	 public int Getnot(){return this.not;}
  	   	 public String Getusername(){ return this.username;}
  	 	 public String Getstatusoftask(){return this.statusoftask;}
  	...
  	public supervisor()
  	{
  		...
  		l=new leave();}
   	/**@brief add staff*/ 
  	public void addstaff(dept d,staff st){d.arr[++d.nos]=st;}
  	/**@brief delete staff*/ 
  	public void deletestaff(dept d,staff st)
  	{
  	int kk,h;
  	...
  	public void modifynewuser(newuser [] n,newuser nn)
	{
  	...
  	public void sendleave(leave ll){	this.l=ll;}
  	...
  	{int count=0;
  		...
  		if(tk.Getstatus().equals("Complete"))
			...
			f.setWritable(true);
  			...
  			StringBuilder sb = new StringBuilder();
  			sb.append(Porsche.charAt(6));sb.append(Porsche.charAt(7));sb.append(Porsche.charAt(8));
  			sb.append(Porsche.charAt(9));String str = sb.toString();
  			
  			StringBuilder sb2 = new StringBuilder();
  			//if(Porsche.charAt(4)!='0')
  			sb2.append(Porsche.charAt(3));sb2.append(Porsche.charAt(4));
  					String str2 = sb2.toString();
