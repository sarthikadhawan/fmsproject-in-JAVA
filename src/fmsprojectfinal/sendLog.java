...
{
	private JTextField[] arrayOfFields = new JTextField[11];  /**< the log requests will be stored in this array */
	private JTextField numOfreq; /**< the user have to specify the no of the log req */
	...
	/** @brief it will return a JFrame having num number of textfields 
	 * 
	 * @param num
	 * @return
	 */
	...
	/** @brief actionlistener of events */
